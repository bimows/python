...
print "Tampilanya seperti ini: {}, {}".format(current_excercise, todays_date)
...
print "Tampilanya seperti ini: {}, {}, {}, {}".format(mirthful_addition, amazing_subtraction, trippy_multiplication, sassy_combinations)
print "Atau Seperti ini:"
...
"""
Bimo Sedang Mengomentari
tapi kurang panjang
dan bingung mau nulis apa.
"""
